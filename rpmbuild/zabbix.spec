...
install -m 0644 conf/zabbix_agentd/zbx.conf $RPM_BUILD_ROOT%{_sysconfdir}/zabbix/zabbix_agentd.d
...
%config(noreplace) %{_sysconfdir}/zabbix/zabbix_agentd.d/zbx.conf
